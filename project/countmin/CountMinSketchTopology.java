...
public class CountMinSketchTopology {
	...
	System.out.println("keys: "+consumerKey);
	...
	public static void main(String[] args) throws Exception {
		...
		String sw[] = {"to","the", "a", "an"};//stopwords.
		CustomStopWords cs = new CustomStopWords(sw);//for building the bloomfilter of stopwords
        	...
        	for (int i = 0; i < 5; i++) {
            		...
            		System.out.println("DRPC RESULT:"+ drpc.execute("get_count","a the you was my on"));//pass the words to be queried.
            		Thread.sleep(3000 );
        	}
